...
WSMETHOD GET ConsultarPedido QUERYPARAM numero WSREST PedidoCompras
    ...
    */
	if Empty(cPedido)
		Self:SetResponse('{"noPedido":"' + cPedido + '", "infoMessage":"", "errorMessage":"Numero do Pedido não informado"}')
	...
	ELSE
		Self:SetResponse('{"noPedido":"'+cPedido+'", "infoMessage":"", "errorMessage":"Numero do Pedido não encontrado"}') 
